 ...
 * the model itself. Used as a read-only element send via the LAS2peer network to the
...
public class SimpleModel implements Serializable {
   ...
   * Creates a new model.
   * 
   * @param modelId the id of this @link{SimpleModel}
   ...
   * 
   */
  public SimpleModel(int modelId, String name, ArrayList<SimpleNode> nodes,
      ArrayList<SimpleEdge> edges, ArrayList<SimpleEntityAttribute> attributes) {
    this.id = modelId;
    this.name = name;
    this.nodes = nodes;
    this.edges = edges;
